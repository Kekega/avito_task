...
//
// SenderId and ServiceId are "positional". The transaction Amount (which is positive) is always subtracted from
// sender's deposit and added to recipient's deposit.
//
// If a transaction is missing a ServiceId, it is considered a deposit withdrawal.
...
type Transaction struct {
	...
	ServiceId uuid.UUID `json:"recipient_id,omitempty"`
